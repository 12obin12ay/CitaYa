...
public class EspecialidadesActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        // Refresca los contadores por si el usuario canceló/completó una cita
        // en otra pantalla y volvió aquí.
        actualizarContadoresEspecialidades();
    }
    ...
    // ================== DISPONIBILIDAD POR DOCTOR (contra la BASE DE DATOS) ==================
     ...
     * según la tabla "horarios" de la base de datos.
     */
    ...
    private int contarDoctoresDisponibles(String especialidad) {
        ...
        for (Doctor d : doctores) {
            if (!doctorCompletamenteOcupado(d.nombre)) {
                disponibles++;
            }
        }
        return disponibles;
     ...
     * Estructura: card -> [icono, contenedorTextos[titulo, subtitulo]]
     */
        ...
        DatePickerDialog dp = new DatePickerDialog(
                ...
                (view, y, m, d) -> {
                    ...
                    for (LinearLayout h : horas) {
                        ...
                        if (ocupado || horaYaPaso(fechaSeleccionada, hora)) {
                            h.setEnabled(false);
                            h.setAlpha(0.3f);
                        } else {
                            h.setEnabled(true);
    ...
    private void confirmarCita() {
        ...
        // El usuario ya tiene una cita ese mismo día y hora
        ...
        // El doctor ya tiene paciente en esa hora
        ...
        // Verificar horario ocupado (chequeo final antes de escribir)
